...
-- DataMined from WowHead items?filter=cr=133:152;crs=1:6;crv=0:0 on 17/02/2017
-- Scraped 16 items
-- DataMined from WowHead items?filter=cr=133:152;crs=1:11;crv=0:0 on 17/02/2017
-- Scraped 18 items
-- DataMined from WowHead items?filter=cr=133:152;crs=1:3;crv=0:0 on 17/02/2017
-- Scraped 16 items
-- DataMined from WowHead items?filter=cr=133:152;crs=1:8;crv=0:0 on 17/02/2017
-- Scraped 17 items
ns.classBoa=
{
  ["102290"] = 400,
...
-- DataMined from WowHead items?filter=na=battlestone;cr=133;crs=1;crv=0 on 17/02/2017
-- Scraped 21 items
ns.battlestones={
...
-- DataMined from WowHead items?filter=na=training;cr=133;crs=1;crv=0 on 17/02/2017
-- Scraped 12 items
ns.trainingstones={
